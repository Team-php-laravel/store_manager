...
<div class="col-md-12">
    ...
    <div class="card card-primary">
        ...
        <form role="form" method="POST" action="admin/news/add" enctype="multipart/form-data">
            @csrf
            <div class="card-body">
                <div class="form-group">
                    <label for="">Tiêu đề</label>
                    <input type="text" name="tieu_de" value="" class="form-control">
                ...
                <div class="form-group">
                    ...
                    <input type="text" name="mo_ta" value="" class="form-control">
                    @if ($errors->has('mo_ta'))
